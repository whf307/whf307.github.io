...
![p1](/images/image-20181102225907753.png){:height="100%" width="100%"}
...
![]({{"/images/image-20181102160751729.png" | absolute_url }}){:height="100%" width="100%"}
...
![](/images/image-20181102160751729.png){:height="100%" width="100%"}
...
![](/images/image-20181102223341528.png){:height="100%" width="100%"}

用G直接到文件尾，linux下所有的文件都是0x0a结尾的，文件大小是没有问题的，每行**16**个bytes（两个十六进制位是一个byte ）。**0x1fe0**就是十进制的8160，按照我们上面说的，接下来4 bytes是t_xmin。我们从vi里面看到的是0x5a020000，这里是大端，正确的应该是0x0000025a，十进制就是**602**了，跟我们之前pageinspect看到的结果一致。

**t_xmax**

接下来是t_xmax 4 bytes，我们可以看到它是0x5b020000，同样正确的是0x0000025b，十进制603，这里我们修改成0x00000000，如下:

![](/images/image-20181102223914046.png){:height="100%" width="100%"}
...
![](/images/image-20181102224656011.png){:height="100%" width="100%"}
...
![](/images/image-20181102225028352.png){:height="100%" width="100%"}
